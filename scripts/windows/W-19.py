...
def check():
    ...
    cmd_str = r'''Get-WindowsFeature Web-Server -ErrorAction SilentlyContinue | Select-Object Name,InstallState; Get-Service W3SVC -ErrorAction SilentlyContinue | Select-Object Name,Status'''
