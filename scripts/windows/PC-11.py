...
def check():
    category = "패치 관리"
    item_code = "PC-11"
    item_name = "지원이 종료되지 않은 Windows OS Build 적용"

    cmd_str = r'''[System.Environment]::OSVersion; Get-ComputerInfo | Select-Object OsName,OsVersion,OsBuildNumber,WindowsVersion'''
