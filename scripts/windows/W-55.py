...
def check():
    ...
    cmd_str = r'''Get-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Print\Providers\LanMan Print Services\Servers' -Name 'AddPrinterDrivers' -ErrorAction SilentlyContinue | Select-Object -ExpandProperty AddPrinterDrivers'''
