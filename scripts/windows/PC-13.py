...
def check():
    ...
    cmd_str = r'''Get-MpComputerStatus -ErrorAction SilentlyContinue | Select-Object AntivirusEnabled,AntivirusSignatureLastUpdated,AntispywareEnabled,RealTimeProtectionEnabled; Get-CimInstance -Namespace root/SecurityCenter2 -ClassName AntiVirusProduct -ErrorAction SilentlyContinue | Select-Object displayName,productState'''
