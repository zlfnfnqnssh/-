...
def check():
    ...
    cmd_str = r'''Get-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters' -Name 'AutoDisconnect' -ErrorAction SilentlyContinue | Select-Object -ExpandProperty AutoDisconnect'''
