...
def check():
    ...
    cmd_str = r'''secedit /export /cfg $env:TEMP\secpol.cfg; Select-String -Pattern 'ClearTextPassword' $env:TEMP\secpol.cfg'''
    ...
    try:
        ...
        result = "규칙불가"
        if full_out:
            if "ClearTextPassword = 0" in full_out or "ClearTextPassword= 0" in full_out:
                result = "양호"
            elif "ClearTextPassword = 1" in full_out or "ClearTextPassword= 1" in full_out:
                result = "취약"
