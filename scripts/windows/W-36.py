...
def check():
    category = "서비스 관리"
    item_code = "W-36"
    item_name = "원격터미널 접속 타임아웃 설정"

    cmd_str = r'''Get-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services' -Name 'MaxIdleTime','MaxDisconnectionTime','MaxConnectionTime' -ErrorAction SilentlyContinue | Format-List'''
