...
def check():
    ...
    cmd_str = r'''Get-NetFirewallProfile | Select-Object Name,Enabled; netsh advfirewall show allprofiles state'''
    ...
    try:
        ...
        if full_out:
            ...
            if "false" in lower_out or "off" in lower_out:
                result = "취약"
            elif "true" in lower_out or "on" in lower_out or "enabled" in lower_out:
                result = "양호"
